...
void print_matrix( string name, vector<bool>* M, bool border = false )
{
	int add = border ? 0 : 1;
	cout << name << ":" << endl;
...
int main( int argc, char* argv[] )
{
	...
	try
	{
		MREAD = new vector<bool>( numCells );
		MWRITE = new vector<bool>( numCells );
	}
