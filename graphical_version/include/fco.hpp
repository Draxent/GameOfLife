...
namespace fco
{
	...
	public:
		...
		///  Initializes a new instance of the \see FCO (Formatted Console Output) class.
		FCO();
		...
		* @param fco	given \see FCO object.
		* @return		a \see FCO object with stylistic properties obtained from the sum explained above.
		*/
		FCO operator+(const FCO& fco) const;

		/// Destructor of the \see FCO class.
		~FCO();
